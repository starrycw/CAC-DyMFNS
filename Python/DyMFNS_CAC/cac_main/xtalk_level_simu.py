...
def simu_9X9_dymfns_rowbyrow_100000_faultfree():
...
def simu_9X9_dymfns_rowbyrow_100000_randomfault01():
    Xtalk_simu = cac_main.cac_xtalk_level.Array_Xtalk_Calculator(n_row=9, n_col=9)
    cnt_xtalk = {0: 0,
                 0.25: 0,
                 0.5: 0,
...
# 9X9阵列 未编码随机数 100000
def simu_9X9_uncoded_100000_faultfree():
    Xtalk_simu = cac_main.cac_xtalk_level.Array_Xtalk_Calculator(n_row=9, n_col=9)
    datain_lenmax = 9
    datain_max = (2 ** datain_lenmax) - 1
    cw_tuple_old = 9 * ( (0, 0, 0, 0, 0, 0, 0, 0, 0), )
