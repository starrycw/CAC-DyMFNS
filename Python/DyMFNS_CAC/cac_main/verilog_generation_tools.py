...
def verilog_generate_CascadedDyMFNSAddersNormal(n):
    ...
    def print_output_ports_decl(id, is_end):
        ...
        print("    input wire [`DYMFNS_ADDER_OUTA_BLEN_{} - 1 : 0] out_a_{},".format(id, id_str))
        print("    input wire [`DYMFNS_ADDER_OUTB_BLEN_{} - 1 : 0] out_b_{}{}".format(id, id_str, endstr))
    ...
    if n < 10:
        ...
        n_str = "{}".format(n)
    print("// Generated by cac_main.verilog_generation_tools. Version: 2022.01.08.00")
    print("`include \"Header_DyMFNS.vh\"")
    print("module DyMFNS_CascadedAdders_N{}(".format(n_str))
    print("    // flags")
    print("    input wire [1:{}] flags,".format(n))
    print("    // Output ports")
    print("    input wire out_a_01,")
    print("    input wire out_b_01,")
    for temp_id_i in range(2, n):
        print_output_ports_decl(id=temp_id_i, is_end=False)
    print_output_ports_decl(id=n, is_end=True)
    print("    );")
