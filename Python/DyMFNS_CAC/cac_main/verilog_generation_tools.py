...
def verilog_generate_code_DyMFNSAdder(adder_id):
    '''
    ...
    print("// Generated by cac_main.verilog_generation_tools.verilog_generate_code_AFNSAdder(), version: 2022010200.")
    ...
    print("    output wire [`DYMFNS_ADDER_OUTB_BLEN_2 - 1 : 0] out_b".format(adder_id))
    print("    );")
    print("    ")
...
def sverilog_generate_code_simuDyMFNSAdders(n):
    '''
...
def sverilog_generate_code_simuAFNSAdders(n):
    '''
...
#################################main
sverilog_generate_code_simuAFNSAdders(n=20)
